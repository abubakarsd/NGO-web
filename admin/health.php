        ...
        <ul class="list">
            ...
            <li class="active open"><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-label col-red"></i><span>Initiative</span> </a>
                <ul class="ml-menu collapse">
                    ...
                    <li class="active open"><a href="health.php">Health & Personal Hygiene</a> </li>
                </ul>
            </li>
    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                <h2>Health & Personal Hygiene
                    <small>Welcome to Youth Health & Personal Hygiene</small>
                </h2>
            </div>
            <div class="col-lg-5 col-md-6 col-sm-12">
                <ul class="breadcrumb float-md-right">
                    <li class="breadcrumb-item"><a href="index.php"><i class="zmdi zmdi-home"></i> Home</a></li>
                    <li class="breadcrumb-item"><a href="blog-dashboard.html">Health & Personal Hygiene</a></li>
...
var myDropzone = new Dropzone("#frmFileUpload", {
    ...
    $(document).ready(function(){
        ...
        $.ajax({
            url: "includes/fetch_initiative_health.php",
            method: "GET",
        ...
        $(document).on('click', '.btn-edit', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "includes/fetch_health_info.php",
                dataType: 'json',
        ...
        $(document).on('submit', '#initiative_form', function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "includes/update_health_db.php",
