        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-6 col-sm-12">
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item"><a href="blog-dashboard.html">Uew</a></li>
                    <li class="breadcrumb-item active">Urgent Donation</li>
                </ul>
            </div>
        </div>
    </div>
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Post new donation</strong></h2>
                    </div>
                    <div class="body">
                ...
                <div class="input-group">
                    ...
                    <input type="date" class="form-control datetimepicker" id="donation_date" name="donation_date" placeholder="Please choose date & time...">
                </div>
                <div class="form-group">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success btn-round waves-effect">Post Donation</button>
                </div>
            </form>
                    </div>
                </div>
...
var myDropzone = new Dropzone("#frmFileUpload", {
    url: "http://localhost/NGO web/admin/create-donation.php", // Specify the URL for uploading files
    ...
    $(document).ready(function () {
        ...
        function fetch_users_info() {
         ...
         $(document).on('submit', '#donation_form', function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "includes/post_donation.php",
