...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $con->prepare("INSERT INTO tbl_program (program_img, program_head, prog_location, prog_date, prog_discription) VALUES (:program_img, :program_head, :prog_location, :prog_date, :prog_discription)");
